package com.reinertisa.sta.constant;
...
public class Constants {
    ...
    // Query
    public static final String SELECT_DOCUMENTS_QUERY = "SELECT doc.id, doc.document_id, doc.name, " +
            "doc.description, doc.uri, doc.icon, doc.size, doc.formatted_size, doc.extension, " +
            "doc.reference_id, doc.created_at, doc.updated_at, " +
    ...
    public static final String SELECT_DOCUMENT_QUERY = "SELECT doc.id, doc.document_id, doc.name, " +
            "doc.description, doc.uri, doc.icon, doc.size, doc.formatted_size, doc.extension, " +
            "doc.reference_id, doc.created_at, doc.updated_at, " +
            "CONCAT(owner.first_name, ' ', owner.last_name) AS owner_name, " +
            "owner.email AS owner_email, " +
    ...
    public static final String SELECT_DOCUMENTS_BY_NAME_QUERY = "SELECT doc.id, doc.document_id, doc.name, " +
            "doc.description, doc.uri, doc.icon, doc.size, doc.formatted_size, doc.extension, " +
            "doc.reference_id, doc.created_at, doc.updated_at, " +
            "CONCAT(owner.first_name, ' ', owner.last_name) AS owner_name, " +
            "owner.email AS owner_email, " +
