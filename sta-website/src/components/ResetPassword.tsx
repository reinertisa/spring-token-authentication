                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            {error && <div className="alert alert-dismissible alert-danger">
                                {'data' in error ? (error.data as IResponse<void>).message : 'An error occurred'}</div>}
                            {isSuccess && <div className="alert alert-dismissible alert-success">
                                {(data as IResponse<void>).message || 'We sent you an email for you to reset password'}</div>}
                            <hr />
