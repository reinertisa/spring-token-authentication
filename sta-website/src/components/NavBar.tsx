                        ...
                        <div className="flex-shrink-0 dropdown">
                            <a className="d-block link-body-emphasis text-decoration-none dropdown-toggle profile-dropdown"
                               ...
                               data-bs-toggle="dropdown" aria-expanded="false">
                                <img
                                    src={isLoading ? 'https://giphy.com/gifs/taco-tacos-KVGy0GTCJ4GI0' : user?.data.user.imageUrl}
                            ...
                            <ul className="dropdown-menu dropdown-menu-end" style={{paddingInline: '10px'}}>
                                ...
                                <li>
                                    <NavLink to="/user/authorization" end
                                             className="rounded2 dropdown-item d-flex gap-2 align-items-center">
                                ...
                                <li>
                                    <a onClick={onLogout}
                                       className="rounded-2 dropdown-item dropdown-item dropdown-item-danger d-flex gap-2 align-items-center">
