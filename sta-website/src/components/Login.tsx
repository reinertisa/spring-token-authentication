...
export default function Login() {
    ...
    const {register: qrCodeRegister, handleSubmit: submitQrCode, formState: qrCodeForm, getFieldState: getQrCodeField} = useForm<QrCodeRequest>({
                    ...
                    <div className="col-lg-5 text-center">
                        ...
                        <div className="card mt-5">
                            <div className="card-body">
                                ...
                                {qrCodeError && <div className="alert alert-dismissible alert-danger">{'data' in qrCodeError ? (qrCodeError.data as IResponse<void>).message : 'An error occurred'}</div>}
                                <hr />
